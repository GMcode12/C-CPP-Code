...
class Detail
{
    ...
    void displaydetail()
    {
        cout <<"\n|Train No." << setw(15) << "|Train Name" <<setw(20) << "|Boarding pt." << setw(15)<< "|Destination pt."  <<setw(20);
        cout << "|F-Class" << setw(15)<< "|F-Class Fare" << setw(15)<< "|S-Class" << setw(15) << "|S-Class Fare" <<setw(15);
        cout << "|D" << "-" << "M" << "-" << "Y" << "\n";
        
        cout << "|" << tno << setw(10)<< "|" << tname << setw(10)<< "|" << bp << setw(10) << "|" << dest <<setw(10);
        cout << "|" << c1 << setw(10) << "|"<< c1fare << setw(10) << "|" << c2<< setw(10) << "|" << c2fare <<setw(10);
        cout << "|" << d << "-" << m << "-" << y << "\n";
    }
};
class reser
            ...
            if (strcmp(b.clas, f) == 0)
            {
                if (a.c1 >= b.nosr)
                {
                    ...
                    if (b.con == 1)
                    {
                        ...
                        b.amc = b.nosr * ((amt * 50) / 150);
                    }
                    else if (b.con == 2)
                    {
                        cout << "Concession category:SENIOR CITIZEN\n";
                        b.amc = b.nosr * ((amt * 60) / 150);
                    }
                    else if (b.con == 3)
                    {
